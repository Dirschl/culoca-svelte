...
-- Create a working function with correct types
CREATE OR REPLACE FUNCTION public.items_by_distance_working(
...
GRANT EXECUTE ON FUNCTION public.items_by_distance_working TO authenticated;
GRANT EXECUTE ON FUNCTION public.items_by_distance_working TO anon; 