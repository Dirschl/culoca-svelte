<script lang="ts">
  ...
  function handleSettings() {
    ...
    // Also dispatch rotation speed increase event for mobile mode
    window.dispatchEvent(new CustomEvent('increaseRotationSpeed'));
  }
...
<div class="fab-container">
  ...
  {#if $hasSettingsPermission}
    ...
    <svg 
      ...
      stroke="currentColor" 
      stroke-width="2"
      style="transform: rotate({settingsIconRotation + continuousRotation}deg); transition: transform 0.5s ease;"
    >
