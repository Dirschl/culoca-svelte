 ...
 * - noimageindex (nur Token): /images/{slug}-512.*, /images/similar/…, ?context=similar, /images/embed/…
 *
...
export const ITEM_PAGE_PROFILE_SELECT = [
	...
	'show_social',
	'privacy_mode',
	// Attribution / Rechte (für Meta-Tags, JSON-LD, sichtbare „Ersteller“-Box)
	'display_name_public',
	'legal_entity_name',
...
export function fixUtf8MojibakeIfNeeded(
	input: string | null | undefined
): string | null | undefined {
	return fixTextEncodingIfNeeded(input);
}

export function scrubPublicProfileRow(
