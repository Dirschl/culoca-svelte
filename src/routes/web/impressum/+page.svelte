...
>
  ...
  <h2 style="margin-top: 2rem;">Angaben gemäß § 5 TMG</h2>
  
  <div class="contact-info">
    <h4 style="margin-top: 2rem; margin-bottom: 1rem; text-decoration: underline;">Verantwortlich für den Inhalt</h4>
    <ul>
  ...
  <h3 style="margin-top: 2rem;">Urheberrecht</h3>
  <p>
