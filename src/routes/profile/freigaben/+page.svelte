  ...
  const useCases = [
    {
      ...
      text: 'Ideal für Kunden, die pauschal abrechnen und alle Items deines Profils ohne Einzelfreigaben herunterladen oder weiterverwenden dürfen.'
    },
    {
      title: 'Kollegen für Redaktion und Pflege',
      text: 'Geeignet für Teammitglieder, die deine gesamten Einträge laufend überarbeiten, ergänzen oder bei Bedarf auch entfernen sollen.'
    },
    {
      title: 'Einzelrechte pro Item bleiben möglich',
      text: 'Wenn Rechte nur punktuell für bestimmte Einträge gelten sollen, vergib sie direkt am jeweiligen Item anstatt hier profilweit.'
    }
  ];

  const rightsLegend = [
    { label: 'Download', text: 'Erlaubt die Nutzung und das Herunterladen aller Items dieses Profils.' },
    { label: 'Bearbeiten', text: 'Erlaubt Änderungen an Titeln, Beschreibungen, Metadaten und weiteren Inhalten.' },
    { label: 'Löschen', text: 'Erlaubt das Entfernen von Einträgen aus deinem Profil. Dieses Recht nur sehr gezielt vergeben.' }
  ];
    ...
    <main class="rights-main">
      <section class="hero">
        <div class="hero-copy surface-responsive surface-responsive--panel">
          ...
          <p class="hero-text">
            Diese Freigaben gelten nicht nur für Fotos, sondern für alle Items deines Profils. Sie sind für Situationen gedacht, in denen Personen dauerhaft und umfassend mit deinem gesamten Bestand arbeiten dürfen.
          </p>
          <div class="hero-note">
            Einzelne Rechte direkt an einem Item bleiben weiterhin möglich, wenn du nur gezielt Einträge für Dritte freigeben willst.
          </div>
        </div>
