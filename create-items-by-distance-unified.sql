-- Create unified function for all distance-based queries
-- Supports both location filtering and search functionality
...
BEGIN
    ...
    ORDER BY 
        CASE 
            WHEN user_lat IS NOT NULL AND user_lon IS NOT NULL THEN distance
