-- Fix gallery_items_normal_postgis function overloading
-- Create both function signatures: with and without search_term parameter
...
-- Create the function with 5 parameters (for normal gallery)
...
-- Create the function with 6 parameters (for search)
CREATE OR REPLACE FUNCTION public.gallery_items_normal_postgis(
  user_lat double precision DEFAULT 0, 
  user_lon double precision DEFAULT 0, 
  page_value integer DEFAULT 0, 
...
-- Set ownership for both function signatures
