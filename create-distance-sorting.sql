-- Create distance-based sorting function
-- This function will handle all sorting in the database

DROP FUNCTION IF EXISTS public.get_items_by_distance(uuid, uuid, integer, integer, boolean, text, double precision, double precision);

CREATE OR REPLACE FUNCTION public.get_items_by_distance(
...
GRANT EXECUTE ON FUNCTION public.get_items_by_distance TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_by_distance TO anon; 