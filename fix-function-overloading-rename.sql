-- Fix function overloading by using distinct names
...
-- Create the function for normal gallery (5 parameters)
...
-- Create the function for search (6 parameters) with different name
