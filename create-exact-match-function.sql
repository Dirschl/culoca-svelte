...
DROP FUNCTION IF EXISTS public.get_items_simple(uuid, uuid, integer, integer, boolean, text, double precision, double precision);
...
-- Create function with EXACT column types from the items table
CREATE OR REPLACE FUNCTION public.get_items_exact(
...
GRANT EXECUTE ON FUNCTION public.get_items_exact TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_exact TO anon; 