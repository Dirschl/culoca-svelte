-- Gallery Items Normal RPC Function
-- Für die normale Galerie mit GPS-Entfernungsberechnung direkt in PostgreSQL
CREATE OR REPLACE FUNCTION gallery_items_normal_rpc(
