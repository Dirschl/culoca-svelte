-- Lösche zuerst die alte einfache Funktion und erstelle sie neu mit korrekten Datentypen

-- 1. Lösche die alte Funktion
DROP FUNCTION IF EXISTS map_images_postgis_simple(DOUBLE PRECISION, DOUBLE PRECISION, UUID);

-- 2. Erstelle die neue einfache Funktion mit korrekten Datentypen
...
SELECT * FROM map_images_postgis_simple(0, 0, NULL) LIMIT 5; 