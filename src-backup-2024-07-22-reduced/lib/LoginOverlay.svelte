<script lang="ts">
  ...
  export let loginWithProvider: (provider: string) => void;
  export let loginWithEmail: () => void;
  export let signupWithEmail: () => void;
  export let resetPassword: () => void;
  export let setAnonymousMode: () => void;
</script>

{#if show && !isLoggedIn && authChecked}
  <div class="modern-login-overlay" on:click={onClose}>
