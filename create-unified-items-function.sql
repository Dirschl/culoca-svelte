-- Create a new unified function with a unique name
-- This function handles all item queries with server-side sorting

CREATE OR REPLACE FUNCTION public.get_items_unified(
...
GRANT EXECUTE ON FUNCTION public.get_items_unified TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_unified TO anon; 