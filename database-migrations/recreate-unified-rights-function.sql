-- Recreate the unified rights function completely
-- This migration completely recreates the function with a simpler approach
-- Führe dieses Script im Supabase Dashboard aus

-- Drop the existing function
DROP FUNCTION IF EXISTS get_unified_item_rights(UUID, UUID);

-- Create the function with a simpler, more direct approach
...
-- Confirmation
SELECT 'Unified rights function recreated successfully!' as status;
