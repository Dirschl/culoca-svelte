-- Complete Rights System Migration
-- This migration creates all necessary tables and relationships from scratch
-- Führe dieses Script im Supabase Dashboard aus

-- 1. Drop existing tables if they exist (BE CAREFUL - this will delete existing data!)
DROP TABLE IF EXISTS item_rights CASCADE;
DROP TABLE IF EXISTS profile_rights CASCADE;

-- 2. Create profile_rights table
...
-- 11. Create RLS policies for profile_rights
...
-- 12. Create RLS policies for item_rights
...
-- 14. Confirmation
SELECT 'Complete rights system successfully installed!' as status;
