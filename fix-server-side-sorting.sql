...
DROP FUNCTION IF EXISTS public.get_items_server_sorted(uuid, uuid, integer, integer, boolean, text, double precision, double precision);

CREATE OR REPLACE FUNCTION public.get_items_server_sorted(
...
GRANT EXECUTE ON FUNCTION public.get_items_server_sorted TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_server_sorted TO anon; 