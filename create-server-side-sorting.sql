-- Create a function for server-side sorting with correct types
-- This function will handle all sorting in the database

DROP FUNCTION IF EXISTS public.get_items_sorted(uuid, uuid, integer, integer, boolean, text, double precision, double precision);

CREATE OR REPLACE FUNCTION public.get_items_sorted(
...
GRANT EXECUTE ON FUNCTION public.get_items_sorted TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_sorted TO anon; 