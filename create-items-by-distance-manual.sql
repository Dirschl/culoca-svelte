-- Create items_by_distance_manual function for server-side distance sorting
-- This ensures correct pagination with distance-based sorting

DROP FUNCTION IF EXISTS items_by_distance_manual(DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, INTEGER, UUID, BOOLEAN, UUID);

CREATE OR REPLACE FUNCTION items_by_distance_manual(
...
GRANT EXECUTE ON FUNCTION items_by_distance_manual(DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, INTEGER, UUID, BOOLEAN, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION items_by_distance_manual(DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, INTEGER, UUID, BOOLEAN, UUID) TO anon;
