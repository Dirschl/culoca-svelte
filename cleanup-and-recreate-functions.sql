-- Clean up and recreate functions to avoid overloading conflicts
-- Drop ALL possible versions of the functions

-- Drop all versions of gallery_items_normal_postgis
...
DROP FUNCTION IF EXISTS public.gallery_items_normal_postgis(double precision, double precision, integer, integer);
DROP FUNCTION IF EXISTS public.gallery_items_normal_postgis(double precision, double precision, integer, integer, uuid, double precision, double precision);

-- Drop all versions of gallery_items_search_postgis
...
DROP FUNCTION IF EXISTS public.gallery_items_search_postgis(double precision, double precision, integer, integer);
DROP FUNCTION IF EXISTS public.gallery_items_search_postgis(double precision, double precision, integer, integer, uuid, double precision, double precision);

-- Create ONLY the normal gallery function (5 parameters)
...
-- Create ONLY the search function (6 parameters)
...
-- Grant permissions for the correct functions only
...
-- Set ownership for the correct functions only
