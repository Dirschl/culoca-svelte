-- Create REAL server-side sorting function
-- This function will handle ALL items with proper pagination

DROP FUNCTION IF EXISTS public.get_items_by_distance_real(uuid, uuid, integer, integer, boolean, text, double precision, double precision);

CREATE OR REPLACE FUNCTION public.get_items_by_distance_real(
...
GRANT EXECUTE ON FUNCTION public.get_items_by_distance_real TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_items_by_distance_real TO anon; 