...
function checkGPSAvailability() {
	...
	// Check window object
	const windowLat = window.userLat;
	const windowLon = window.userLon;
...
async function runAllTests() {
	...
	console.log(
		'- GPS Available:',
		!!(gpsCheck.windowLat || gpsCheck.storedLat || gpsCheck.sessionLat)
	);
...
console.log(
	'✅ Debug functions loaded. Run window.debugGPSAndGallery.runAllTests() to test everything.'
);
