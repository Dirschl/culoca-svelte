-- Fix RLS policies for download history access
-- This script allows admins to view download history
...
DROP POLICY IF EXISTS "Admins can view all downloads" ON item_downloads;
...
-- Allow admins to view all downloads (for analytics)
...
-- Test the policies
SELECT 'RLS policies for download history fixed successfully!' as status;
