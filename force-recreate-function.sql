-- Force drop ALL possible versions of the function
DROP FUNCTION IF EXISTS public.items_by_distance_unified(uuid, uuid, integer, integer, boolean, double precision, double precision);
DROP FUNCTION IF EXISTS public.items_by_distance_unified(double precision, double precision, integer, integer, uuid, boolean, uuid);
...
DROP FUNCTION IF EXISTS public.items_by_distance_unified(text, text, integer, integer, boolean, text, double precision, double precision);

-- Create a completely new function with a different name
CREATE OR REPLACE FUNCTION public.items_by_distance_final(
...
GRANT EXECUTE ON FUNCTION public.items_by_distance_final TO authenticated;
GRANT EXECUTE ON FUNCTION public.items_by_distance_final TO anon; 